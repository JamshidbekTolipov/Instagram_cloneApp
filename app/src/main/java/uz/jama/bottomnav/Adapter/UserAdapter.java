...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imageProfile = itemView.findViewById(R.id.image_profile_usi);
            username = itemView.findViewById(R.id.username_usi);
            fullname = itemView.findViewById(R.id.fullname_usi);
            btnFollow = itemView.findViewById(R.id.btn_follow_usi);
